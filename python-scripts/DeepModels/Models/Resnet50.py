...
def load_model(input_shape, num_classes=1000):
    ...
    x_fc = AveragePooling2D((7, 7), name='avg_poola')(x)
    x_fc = Flatten()(x_fc)
    x_fc = Dense(num_classes, activation='softmax', name='fc1000a')(x_fc)
    ...
    #sgd = SGD(lr=learning, decay=decay, momentum=0.9, nesterov=True)
