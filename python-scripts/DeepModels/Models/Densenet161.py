...
def load_model(input_shape, nb_dense_block=4, growth_rate=48, nb_filter=96, reduction=0.5, dropout_rate=0.0, weight_decay=1e-4, num_classes=None):
    '''
    ...
    x_newfc = Dense(num_classes, name='fc6a')(x_newfc)
    x_newfc = Activation('softmax', name='proba')(x_newfc)
