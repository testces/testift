...
def load_model(input_shape, nb_dense_block=4, growth_rate=32, nb_filter=64, reduction=0.5, dropout_rate=0.0, weight_decay=1e-4, num_classes=1000):
    '''
    ...
    x_fc = Dense(num_classes, kernel_initializer='glorot_normal', name='fc6a')(x_fc)
    x_fc = Activation('softmax', name='proba')(x_fc)
