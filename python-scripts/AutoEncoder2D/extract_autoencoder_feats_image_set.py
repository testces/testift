...
def build_argparse():
    prog_desc = \
'''
Extract the feature vectors of an image set using an AutoEncoder2D (Encoder).

The image entry can be a directory or a CSV file, where row contain an image path.
...
'''
    ...
    parser.add_argument('image_entry', type=str,
                        help='Directory or CSV file with pathnames from the images.')
